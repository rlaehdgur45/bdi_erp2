...
public class UploadFile {
	...
	private static final String UPLOAD_PATH = "C:\\bdi_study\\workspace\\git\\bdi_mvc\\WebContent";
	
	
	public static Map<String,String> saveFileList(HttpServletRequest req) throws ServletException{
		if(!ServletFileUpload.isMultipartContent(req)) {
			throw new ServletException("폼형식이 파일 업로드에 적합하지 않습니다.");
		}
